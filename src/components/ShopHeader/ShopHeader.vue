  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports">
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[info.supports[0].type]"  @click="isShowDiscount=true">
          <span class="content-tag">
      ...
      <div class="shop-brief-modal" v-show="isShowNotice">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-tubiaozhizuomoban-" @click="isShowNotice=false"></span>
          </div>
        </div>
    ...
    <div class="activity-sheet" v-show="isShowDiscount">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-tubiaozhizuomoban-" @click="isShowDiscount=false"></span>
        </div>
      </div>
