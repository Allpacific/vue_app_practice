        ...
        <div class="msite_shop_list">
          ...
          <div class="shop_container">
            <ul class="shop_list" v-if="shops.length > 0">
              <li @click="toShop(shop.id)" class="shop_li border-1px" v-for="shop in shops" :key="shop.id">
                <a>
                  <div class="shop_left">
...
import chunk from 'lodash/chunk' // 按需引入，只打包引入的工具函数
...
export default {
  ...
  /* 
    解决swiper轮播不正常的问题？原因：swiper对象必须要在列表数据显示之后创建
    方式1. watch+nextTick()
  ...
  */
  ...
  computed: {
    ...mapState({ 
      // address: 'adrress', 总的state中没有address了
